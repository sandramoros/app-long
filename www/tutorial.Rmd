...
La aplicación acepta **archivos Excel (.xlsx)** con datos en dos formatos posibles, *wide* o *long*. En **Plantilla de descarga** se pueden decargar las dos plantillas para rellenarlas con los datos del usuario.
